...
document.addEventListener("DOMContentLoaded", function(e){
    ...
    const newNav = document.createElement('div');
    newNav.innerHTML = ` 
      <div class="headerSurvey"><p>What do you think about the new Archivesspace? Will you take this <a href="https://docs.google.com/forms/d/e/1FAIpQLSfXe7jzLaC_zSJTfz8l0az5qXaljZz7wNgToC-44OBmS0gddw/viewform"> Quick Survey </a> to help us improve your experience?</p></div>
    `
